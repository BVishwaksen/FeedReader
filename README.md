...
1.  Download (or) Clone this repository and open in your favorite code editor
...
5.  For detailed description on Node click [here](https://nodejs.org/en/)
...
4.  Write a test that loops through each feed in the `allFeeds` object and ensures it has a URL defined  
    _and_ that the URL is not empty
